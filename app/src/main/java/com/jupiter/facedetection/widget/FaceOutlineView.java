...
public class FaceOutlineView extends View {
    ...
    private void drawFaceAnnotations(Canvas canvas, double scale) {
        ...
        Paint centerPaint = new Paint(paint);
        ...
        for (int i = 0; i < mFaces.size(); ++i) {
            ...
            float x = face.getPosition().x + face.getWidth();
            float y = face.getPosition().y + face.getHeight();
            ...
            canvas.drawCircle(x, y, 10, centerPaint);
